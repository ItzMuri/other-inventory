...
Config.MaxInventoryWeight = 220000 -- Max weight a player can carry (default 120kg, written in grams)
Config.MaxInventorySlots = 50 -- Max inventory slots for a player

Config.CleanupDropTime = 15 * 60 -- How many seconds it takes for drops to be untouched before being deleted
Config.MaxDropViewDistance = 5.0 -- The distance in GTA Units that a drop can be seen
